...
public class ClientCommunicationHandler {
    ...
    public static void sendOxigen(String username,String oxigen){
        String tempurl = host+ "/api/data/import/oxigen";
        JSONObject jsonObject = new JSONObject();
        jsonObject.append("username",username);
        jsonObject.append("nivel_oxigen",oxigen);

        postRequest(tempurl,jsonObject);
    }
    public static void sendCalitateSomn(String username,String calitate_somn){
