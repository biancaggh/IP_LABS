    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.item1) {
           ...
           // intent.putExtra("EXTRA_USER", user);
            ...
            Intent intent = new Intent(ListaPacienti.this, AdaugareDiagnostic.class);
           // intent.putExtra("EXTRA_USER", user);
            startActivity(intent);
            ...
            Intent intent = new Intent(ListaPacienti.this, DoctoriProfil.class);
         //   intent.putExtra("EXTRA_USER", user);
            startActivity(intent);
            return true;
        } else if (id == R.id.item5) {

            Intent intent = new Intent(ListaPacienti.this, Login.class);
            startActivity(intent);
